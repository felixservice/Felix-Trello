...
function Sidebar() {
  const { boards, currentBoardId, createBoard, deleteBoard, setCurrentBoard, updateBoard } = useAppStore();
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-3">
        ...
        {boards.map((board) => (
          <motion.div key={board.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div
      ...
      <div className="border-t border-gray-200 dark:border-gray-800 p-4 bg-gray-50 dark:bg-gray-950">
        ...
        <div className="space-y-2 text-xs text-gray-600 dark:text-gray-400 max-h-32 overflow-y-auto">
